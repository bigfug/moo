...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../libs/SMTPEmailLib/release/ -lSMTPEmailLib
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../libs/SMTPEmailLib/debug/ -lSMTPEmailLib
else:unix: LIBS += -L$$OUT_PWD/../libs/SMTPEmailLib/ -lSMTPEmailLib

INCLUDEPATH += $$PWD/../libs/SMTPEmail/src
DEPENDPATH += $$PWD/../libs/SMTPEmail

#DEPENDPATH += $$PWD/../libs/SMTPEmailLib

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/SMTPEmailLib/release/libSMTPEmailLib.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/SMTPEmailLib/debug/libSMTPEmailLib.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/SMTPEmailLib/release/SMTPEmailLib.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../libs/SMTPEmailLib/debug/SMTPEmailLib.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../libs/SMTPEmailLib/libSMTPEmailLib.a
